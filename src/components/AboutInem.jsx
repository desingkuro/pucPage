...
export function AboutInem() {
  return (
    <section className="aboutInem" data-reveal>
        <img src="https://www.inemsimonbolivarsm.edu.co/wp-content/uploads/2024/02/cropped-logo_workspace.png" alt="Logo INEM Simón Bolívar" />
        ...
        <div className='linkInem'>
            ...
            <a href="https://www.inemsimonbolivarsm.edu.co/" target="_blank" rel="noopener noreferrer">
